...
End Function
Function map(ByRef arr As Variant, ByRef funct As funct) As Variant
    Dim newarr() As Variant
    Dim item As Variant
    Dim i As Integer
    For i = 0 To al(arr) - 1
        st item, arr(i)
        Call arad(newarr, funct.run(item))
looplabel2bef:
    Next i
looplabel2aft:
    st map, newarr
...
End Function
 ...
 Function filter(ByRef arr As Variant, ByRef funct As funct) As Variant
    Dim newarr() As Variant
    Dim item As Variant
    Dim i As Integer
    For i = 0 To al(arr) - 1
        st item, arr(i)
        If ((funct.run(item))) Then
...
End Function
 ...
 Function reduce(ByRef arr As Variant, ByRef funct As funct, ByVal base As Variant) As Variant
    Dim item As Variant
    Dim i As Integer
    For i = 0 To al(arr) - 1
        st item, arr(i)
        nt st(base, funct.run(item, base))
looplabel4bef:
    Next i
looplabel4aft:
    st reduce, base
